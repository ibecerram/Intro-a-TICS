				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="col-md-6">
							<fieldset>
								...
								<div class="text-right">
									<button type="submit" class="btn btn-primary">Buscar alumno <i class="icon-paperplane ml-2"></i></button>
								</div>
						...
						<form action="#">
							...
							<div class="text-right">
								<button type="submit" class="btn btn-primary">Editar alumno <i class="icon-paperplane ml-2"></i></button>
							</div>
						</form>
					</div>
				</div>
