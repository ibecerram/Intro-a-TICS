				...
				<div class="card">
					...
					<div class="card-body">
									...
									<div class="col-lg-9">
										<div class="row">
											...
											<div class="text-right">
												<button type="submit" class="btn btn-primary">Buscar materia <i class="icon-paperplane ml-2"></i></button>
											</div>
						...
						<form action="#">
							...
							<div class="text-right">
								<button type="submit" class="btn btn-primary">Editar materia <i class="icon-paperplane ml-2"></i></button>
							</div>
						</form>
					</div>
				</div>
