						...
						<div class="col-md-6">
							<fieldset>
								...
								<div class="text-right">
									<button type="submit" class="btn btn-primary">Buscar docente <i class="icon-folder-search ml-2"></i></button>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<fieldset>
										...
										<div class="text-right">
										<button type="submit" class="btn btn-primary">Actualizar docente <i class="icon-address-book ml-2"></i></button>
										</div>
									</fieldset>
