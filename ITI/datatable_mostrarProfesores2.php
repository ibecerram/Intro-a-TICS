			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Base de datos</span> - Profesores</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Profesores</span>
						</div>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title"><b>PROFESORES</b></h5>
					...
					<div class="card-body">
						...
						<div class="table-responsive">
								<button type="button" class="btn btn-outline-danger"  data-toggle="modal" data-target="#modal_form_horizontal">
									Agregar docente 
									<i class="icon-file-plus ml-2"></i>
								</button>
						</div>
					</div>
					...
					<table class="table datatable-basic table-hover">
						...
						<tbody>
							...
							<tr>
								<td>Edith</td>
								<td>Reynoso Alcocér</td>
								<td>00010</td>
								<td>8341238767</td>
								<td>correo10@gmail.com</td>
								<td>2019</td>
								<td>123456781</td>
								<td class="text-center">
									<div class="list-icons">
								...
								<div class="card-body">
									<form action="#">
										...
										<div class="text-right">
											<button type="submit" class="btn btn-primary">Agregar docente <i class="icon-paperplane ml-2"></i></button>
										</div>
									</form>
								</div>
							</div>
